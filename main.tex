...
An instance of \emph{ScenarioOutput} is shown in \Cref{lst:scenario-output-impl}.
\begin{lstlisting}[style=my-kotlin, language=my-kotlin, label={lst:scenario-output-impl} caption={ScenarioOutput implementation.}]
...
As \Cref{lst:ctrl} shows, the \emph{Controller} creates a map containing all the scenarios and their respective simulators, and then iterates over the map, executing each scenario.
