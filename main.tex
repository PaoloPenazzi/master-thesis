...
it is essential that the framework is designed so that adding new simulators is possible without compromising the functionality of already supported simulators.
%----------------------------------------------------------------------------------------
\chapter{Background}
%----------------------------------------------------------------------------------------
...
In the context of collective adaptive systems, there is a lack of frameworks that allow the user to conduct a series of tests, utilizing different simulators, in a unified environment. 
