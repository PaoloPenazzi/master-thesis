...
The testbed is basically a framework that sits between the user and the various simulators. 
...
YAML is used as configuration language in many projects, such as Kubernetes, Docker, GitHub Actions, and many more.
