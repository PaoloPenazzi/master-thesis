...
\begin{lstlisting}[float=h!, caption={Benchmark configuration file structure}]
strategy:
  executionOrder:
...
\begin{lstlisting}[language=my-kotlin, float=h!, caption={Benchmark model.}]
@Serializable
...
\begin{lstlisting}[language=my-kotlin, float=h!, caption={SupportedSimulator enum.}]
...
\begin{lstlisting}[language=my-kotlin, float=h!, caption={Parsing of the input file.}]
...
\begin{lstlisting}[language=my-kotlin, float=h!, caption={ConfigFileHandler interface.}]
...
In case it is not available as an option, listener interface can be extended to implement a custom read function. 
...
\begin{lstlisting}[language=my-kotlin, float=h!, caption={Listener interface.}]
  interface Listener {
...
\begin{lstlisting}[language=my-kotlin, float=h!, caption={CSV file cleaning in Alchemist.}]
...
\begin{lstlisting}[language=my-kotlin, float=h!, caption={Benchmark output and result model.}]
...
\begin{lstlisting}[language=my-kotlin, float=h!, caption={Controller implementation.}]
...
\begin{lstlisting}[language=my-kotlin, float=h!, caption={Custom task to generate the JAR file.}]
...
\lstset{style=my-yaml}
\begin{lstlisting}[float=h!, caption={CI/CD workflow.}]
  name: CI/CD Process
on:
  workflow_call:
  workflow_dispatch:
...
\lstset{style=my-kotlin}
\begin{lstlisting}[language=my-kotlin, float=H, caption={Parser tests.}]
...
\lstset{style=my-yaml}
\begin{lstlisting}[float=H, caption={Case of study: benchmark configuration file.}]
strategy:
  executionOrder:
...
\begin{lstlisting}[float=H, caption={Case of study: Alchemist input file.}]
incarnation: sapere
launcher:
...
\lstset{style=my-kotlin}
\begin{lstlisting}[language=my-kotlin, float=h!, caption={Case of study: Output processing function.}]]
