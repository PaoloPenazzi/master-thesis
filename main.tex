...
The tests on this component where conducted by repeatedly running the framework with different scenarios and checking the output manually.
...
The first time the model was run by the framework in headless mode: the process was running and the output correctly saved in a csv file.
The second time the model was run using the NetLogo graphical interface to check if the experiment was correctly executed.
No differences were found between the two outputs.
...
To test if all the user requirements are met.
