...
\begin{lstlisting}[language=my-kotlin]
@Serializable
...
In this section, we will provide an example of how the framework can be use to benchmark \ac*{CAS}.
...
We create a benchmark configuration file, which contains all the informations about the benchmark to be executed.
...
\begin{lstlisting}[style=my-yaml]
incarnation: sapere
launcher:
