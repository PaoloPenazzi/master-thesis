...
\ac{CAS} refers to a form of complex systems where a large number of heterogeneous entities interact without specific external or internal central control and
...
Computation is thus divided and distributed across various devices in the network. This has posed several challenges:

Todo
Todo

Aggregate computing is a macro programming model based on field calculus that aims to simplify the programming of these distributed networks of devices.
...
The Testbed is composed by different components, each with a specific role.
...
In the following diagram is shown a detailed view of the benchmark execution.
